...
public:
	 ...
	 *\brief propriete \e Voltage de l'objet virtual_Alim .
	 */
	__property double VoltageActif = {read = getVoltageActifs, write = setVoltageActifs};
	/**
	 *\brief propriete \e Current de l'objet virtual_Alim .
	 */
	__property double CurrentActif = {read = getCurrentActifs, write = current_actif_m};

	/**
	 *\brief propriete \e ProtVoltage de l'objet virtual_Alim .
	 */
	__property double ProtVoltage = {read = getProtVoltage, write = setProtVoltage};
	/**
	 *\brief propriete \e ProtCurrent de l'objet virtual_Alim .
	 */
	__property double ProtCurrent = {read = getProtCurrent, write = setProtCurrent};
	 ...
	 */
	__property bool ProtectedVoltage = {read = FProtectedVoltage, write = FProtectedVoltage};
	/**
	 *\brief propriete \e Registre Protection en Tension de l'objet virtual_Alim .
	 */
	__property bool ProtectedCurrent = {read = FProtectedCurrent, write = FProtectedCurrent};
	/**
	 *\brief propriete \e Registre Protection en Tension de l'objet virtual_Alim .
	 */
	 ...
	 *\brief propriete \e Registre Protection en Courant de l'objet virtual_Alim .
	 */
	__property double PuissanceMax = {read = getPuissanceMax, write = setPuissanceMax};
